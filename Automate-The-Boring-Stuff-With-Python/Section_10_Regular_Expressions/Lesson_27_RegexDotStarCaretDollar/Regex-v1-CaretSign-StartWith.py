...
caretReturnValue = beginsWithHelloRegex.search('Hello there!')
caretReturnNoneValue = beginsWithHelloRegex.search('He said Hello!"')

# Print to screen the output of the Regex expressions
print(caretReturnValue)
print(caretReturnNoneValue)