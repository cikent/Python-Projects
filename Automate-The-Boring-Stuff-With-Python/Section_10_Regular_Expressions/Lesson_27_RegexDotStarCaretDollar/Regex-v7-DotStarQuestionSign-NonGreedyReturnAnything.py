...
samepleText1 = '<To serve humans> for dinner.>'

# Utilize re.findall() to return a List of all the matches and create a variable to store the data
dotStarQuestionNonGreedyReturnValue = nongreedyRegex.findall(samepleText1)

# Print to screen the output of the Regex expressions
print(dotStarQuestionNonGreedyReturnValue)
