...
# Create a Dot Sign Character Class to find anything that matches the pattern
...
print(dotWildcardReturnValue)           # Notice all values returned are 3 Characters long because .at is 3 as well
