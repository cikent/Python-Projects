...
# Declare String Variable containing a Phone Number WITH no ()
exampleStringNoParentheses = 'My phone number is 415-555-4242'

# Utilize the regex expression search method to create a new Match Object variable IF a pattern match is found
matchObject1 = phoneNumRegex.search(exampleStringNoParentheses)
...
print('The mo.object(3) value is: ' + matchObject1.group(3))
