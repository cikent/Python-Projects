...
mo1 = haRegex.search('He said "HaHa"')

# Search the 2nd Match Object for the Regex Expression String
mo2 = haRegex.search('He said "HaHaHa"')

# Search the 3rd Match Object for the Regex Expression String
mo3 = haRegex.search('He said "HaHaHaHaHaHa"')

# Print to screen True if the mo1 Match Object =='s None due to no results found
print('Print to screen True IF the mo1 Match Object\'s value == None due to no results found')
if mo1 == None:
    print('True')
