...
# Print to screen True if the mo3 Match Object =='s None due to no results found
print('Print to screen True IF the mo3 Match Object\'s value == None due to no results found')
if mo3 == None:
    print('True')